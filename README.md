...
Nesse desafio, desenvolvi mais uma aplicação, a GoRestaurant. O objetivo da aplicação é:  praticar o conceito de CRUD (Create, Read, Update, Delete) utilizando ReactJS e TypeScript.
